...
text(-0.7, 0.125, 'Expert', 'Color', 'r', 'FontSize', 12, 'FontWeight', 'bold', 'HorizontalAlignment', 'left')
text(-0.7, 0.045, 'Naive', 'Color', 'k', 'FontSize', 12, 'FontWeight', 'bold', 'HorizontalAlignment', 'left')
...
stdshade_smooth3(FMTNL, Time, 0.5, 'k', sm_val, 'SEM'); % Naive
...
stdshade_smooth3(FMTEL, Time, 0.5, 'r', sm_val, 'SEM'); % Expert
stdshade_smooth3(FMTOL, Time, 0.5, [0 0.5 0], sm_val, shadetype); % Reversal AL
stdshade_smooth3(FMTRL, Time, 0.5, 'b', sm_val, shadetype); % Reversal RL
...
% Group labels
text(-0.50, 0.128, {'Test', '(ABCD)'}, 'Color', 'r', 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
text(2, 0.04, {'Oddball', '(AAAA)'}, 'Color', [0 0.5 0], 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
text(1.2, 0.215, {'Reversal', '(DCBA)'}, 'Color', 'b', 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
...
stdshade_smooth3(FMTFXSAL, Time, 0.5, [0 0.5 0], sm_val, shadetype); % Reversal AL
stdshade_smooth3(FMTFXSRL, Time, 0.5, 'b', sm_val, shadetype); % Reversal RL
...
% Group labels
text(-0.50, 0.111, {'Test', '(ABCD)'}, 'Color', 'r', 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
text(1.5, 0.188, {'Oddball', '(AAAA)'}, 'Color', [0 0.5 0], 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
text(2, 0.04, {'Reversal', '(DCBA)'}, 'Color', 'b', 'FontSize', 12, ...
    'FontWeight', 'bold', 'HorizontalAlignment', 'center')
